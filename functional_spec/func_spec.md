...
- [3. Functional Requirements](#3-functional-requirements)
  * [3.1 Register Account / Log into Existing Account](#31-register-account---log-into-existing-account)
  * [3.2 Create Organisation](#32-create-organisation)
  * [3.3 Add members to Organisation](#33-add-members-to-organisation)
  * [3.4 View Projects](#34-view-projects)
  * [3.5 Create Project](#35-create-project)
  * [3.6 View Project Backlog](#36-view-project-backlog)
  * [3.7 Create/Delete Tasks in backlog](#37-create-delete-tasks-in-backlog)
  * [3.8 Create Sprint](#38-create-sprint)
  * [3.9 Assign Tasks from Backlog to Sprint](#39-assign-tasks-from-backlog-to-sprint)
  * [3.10 Assign Members/Sprint Master to Project](#310-assign-members-sprint-master-to-project)
  * [3.11 Update Task Status](#311-update-task-status)
  * [3.12 Assign self to task](#312-assign-self-to-task)
  * [3.13 Edit task description](#313-edit-task-description)
  * [3.14 Estimate time for task](#314-estimate-time-for-task)
  * [3.15 Log hours for task](#315-log-hours-for-task)
  * [3.16 Remove Task from Sprint to Backlog](#316-remove-task-from-sprint-to-backlog)
  * [3.17 Complete Sprint](#317-complete-sprint)
  * [3.18 Generate Burndown Chart](#318-generate-burndown-chart)
  * [3.19 Edit Project](#319-edit-project)
  * [3.20 Close Project](#320-close-project)
